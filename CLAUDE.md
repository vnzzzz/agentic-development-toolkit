...
- The workspace itself consumes `vnzzzz/agent-skills` through the Codex / Claude Code Plugin package. Plugin bootstrap may name the package, but must not enumerate individual shared Skills or depend on their internal paths.
