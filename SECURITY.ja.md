...
利用方法とGitHub App permissionsは[GitHub Agent identity](docs/github-agent-identity.ja.md)を参照してください。
...
- Feature contract: [docs/dev-container-feature.ja.md](docs/dev-container-feature.ja.md)
- GitHub Agent identity: [docs/github-agent-identity.ja.md](docs/github-agent-identity.ja.md)
